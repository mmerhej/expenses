...
public class UsersController implements Serializable {
    ...
    @EJB
    private imported_from_db.UsersFacade ejbFacade;
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/expBundle").getString("UsersCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/expBundle").getString("UsersUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/expBundle").getString("UsersDeleted"));
        if (!JsfUtil.isValidationFailed()) {
